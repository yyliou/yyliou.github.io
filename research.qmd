...
```{=html}
<ol reversed start="5" class="wip-list">
...
<li>Does Metro Expansion Always Reduce Traffic Accidents? (with Chang).<span class="paper-earlier">Earlier version presented at the 21st EAEA International Convention (2026).</span></li>
</ol>
```
