...
My research examines how public policy shapes environmental quality, health, and safety. I work mainly with administrative and census records covering whole populations, which allows me to estimate the effects of government intervention at scale. 

My work spans three connected areas of environmental and resource economics. The first studies farm household economics and environmental resource management, including the energy transition on farmland, agricultural input use, and the value of natural capital. The second examines environmental and health externalities in transportation, including carbon emissions, air pollution, and traffic safety. The third studies how firms and households adjust to major policy shifts and external shocks, from carbon border regulation to the COVID-19 pandemic. 

Across these areas I ask how policy should account for costs and benefits that markets fail to price. My aim is to produce evidence that improves policy design and helps governments allocate scarce public resources more efficiently and more equitably.
