...
<div class="bib-stats">
  <div class="bib-stat">
    ...
    <div class="bib-number" data-target="12">0</div>
  </div>
  <div class="bib-stat">
    <div class="bib-label">Cites</div>
    <div class="bib-number" data-target="92">0</div>
  </div>
</div>
...
<div class="cite-chart">
  ...
  <div class="cite-bars">
    <div class="cite-bar-col"><div class="cite-bar-track"><div class="cite-bar" data-h="40"><span class="cite-bar-val" data-val="8">0</span></div></div><span class="cite-bar-year">2021</span></div>
    <div class="cite-bar-col"><div class="cite-bar-track"><div class="cite-bar" data-h="80"><span class="cite-bar-val" data-val="16">0</span></div></div><span class="cite-bar-year">2022</span></div>
    ...
    <div class="cite-bar-col"><div class="cite-bar-track"><div class="cite-bar" data-h="50"><span class="cite-bar-val" data-val="10">0</span></div></div><span class="cite-bar-year">2026</span></div>
  </div>
</div>
...
::: paper-note
*Note*: Three citations cannot be matched to corresponding years; therefore, they are excluded from the figure.
:::

My research has primarily been published in international journals within the fields of regional studies and agricultural economics, including well-recognized outlets such as the *Journal of Transport Geography*, *Transportation Research Parts A and D*, *Food Policy*, and *Forest Policy and Economics*. An overview of these articles is detailed in my [research statement](https://yyliou.github.io/yyliou/rs/rs.pdf).

```{=html}
<div class="quarto-figure quarto-figure-center">
<figure class="figure">
<p><iframe id="vosviewerMap" class="vos-embed" allowfullscreen="true" width="100%" height="75%" style="max-width: 1000px; min-height: 500px" title="Topic network graph of research themes including economics, environmental science, agriculture, revenue, and COVID-19" loading="lazy"></iframe></p>
<figcaption>A network of the research topics spanning my publications.</figcaption>
</figure>
</div>
<script>
(function () {
  var VOS_BASE = 'https://app.vosviewer.com/?item_color=1&item_size=3&item_size_variation=1&json=https%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D1IfL9tQfW8qPlvLEPL5HVDtOmf2A-_ZP1&link_size_variation=1&max_label_length=35&scale=2&simple_ui=true';
  var frame = document.getElementById('vosviewerMap');
  if (!frame) return;
  function syncVosTheme() {
    var dark = document.documentElement.getAttribute('data-theme') === 'dark';
    var src = VOS_BASE + '&dark_ui=' + (dark ? 'true' : 'false');
    if (frame.getAttribute('src') !== src) frame.setAttribute('src', src);
  }
  syncVosTheme();
  if (window.MutationObserver) {
    new MutationObserver(syncVosTheme).observe(document.documentElement, { attributes: true, attributeFilter: ['data-theme'] });
  }
})();
</script>
```
...
::: paper-title
12\. Air Pollution during Religious Holidays: Evidence from Tomb-Sweeping Day
:::

::: paper-meta
***Journal of the Association of Environmental and Resource Economists***, forthcoming (with Chang and Meyerhoefer). §

[[Earlier version](https://ssrn.com/abstract=4984614) presented at the 20th EAEA International Convention (2025), the 99th Annual Conference of WEAI (2024), and the 11th Annual Conference of the IAAE (2024).]{.paper-earlier}
:::

::: paper-links
[Journal](https://doi.org/10.1086/743452){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [EconLit]{.idx-badge}
:::

```{=html}
<div class="abstract-box"><p>Policymakers are under pressure to limit pollution emissions from large-scale religious observances, putting them in conflict with individuals practicing religious rituals. Using the Hakka Tomb-Sweeping Day in Taiwan as an illustration, we show that better information on pollution sources and targeted measures of exposure yield more accurate estimates of the true pollution costs of religious practices. We find that religious activities lower overall air quality by 17.5% during the Tomb-Sweeping Day weekend and increase levels of specific pollutants by 13.6% - 25.7%. In contrast to previous studies suggesting elevated pollution is due to the burning of incense, joss paper and fireworks, we identify greater motor vehicle use and lower travel speed as primary mechanisms. Policies designed to limit the surge in motor vehicle traffic during the holiday could reduce excess health-related costs by NT$33.1 million, equaling 34% of total inpatient and outpatient health care expenditures during the two-day period.</p></div>
<div class="bibtex-box"><pre><code>@article{chang2026air,
...
```{=html}
<a href="https://plu.mx/plum/a/?doi=10.1016%2Fj.foodpol.2026.103148" class="plumx-plum-print-popup" data-popup="right" data-size="large" data-site="plum" data-hide-when-empty="false"></a>
```
:::

::: paper-title
11\. Food traceability systems and the probability of using chemical fertilizers and pesticides − empirical evidence using plot and farm household data from agriculture census
:::

::: paper-meta
***Food Policy***, 143, 103148, 2026 (with Chang). ⁺‡
:::

::: paper-links
[Journal](https://doi.org/10.1016/j.foodpol.2026.103148){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-links
[Journal](https://doi.org/10.1016/j.tra.2026.104860){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [Media]{.paper-btn .media-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
...
<li><a href="https://www.ntu.edu.tw/spotlight/2026/2482_20260429.html" target="_blank" rel="noopener">National Taiwan University — press release: How can institutional reform improve road safety?</a></li>
<li><a href="https://news.ltn.com.tw/news/life/breakingnews/5422721" target="_blank" rel="noopener">Liberty Times Net (自由時報): NTU empirical study finds removing the motorcycle hook-turn safer in specific settings</a></li>
<li><a href="https://www.ettoday.net/news/20260502/3158984.htm" target="_blank" rel="noopener">ETtoday: Accidents down 21% after removing the hook-turn; medical costs cut 4.7%</a></li>
<li><a href="https://www.chinatimes.com/newspapers/20260412000322-260121" target="_blank" rel="noopener">China Times (中國時報): Removing the motorcycle hook-turn cuts accidents 21%</a></li>
</ul></div>
```
:::::::
...
::: paper-links
[Journal](https://doi.org/10.1016/j.trd.2025.104903){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-links
[Journal](https://doi.org/10.1016/j.forpol.2024.103411){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge}
:::
...
::: paper-links
[Journal](https://doi.org/10.1016/j.jtrangeo.2021.102954){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge}
:::
...
::: paper-note
*Note*: † NSTC-recommended journals (Regional Studies & Geography); \* NSTC Economics B+ journals; \^ NSTC-recommended journals (Management II); ⁺ journals ranked in the top 10% of their field by Journal Impact Factor; ‡ National Taiwan University distinguished journals; § National Taiwan University outstanding journals; ¶ National Taiwan University highly cited publications (FWCI top 5%). The NSTC designations follow the [discipline review guidelines of the NSTC Department of Humanities and Social Sciences](https://www.nstc.gov.tw/hum/ch/detail/da71f59b-9ab8-41f4-ae93-5973e0701cc7). The definitions of NTU distinguished journals, outstanding journals, and highly cited publications follow the [National Taiwan University Regulations on Academic Research Performance Awards](https://ord.ntu.edu.tw/WebUPD/ordntu/GW/1140521%E5%9C%8B%E7%AB%8B%E8%87%BA%E7%81%A3%E5%A4%A7%E5%AD%B8%E5%AD%B8%E8%A1%93%E7%A0%94%E7%A9%B6%E7%B8%BE%E6%95%88%E7%8D%8E%E5%8B%B5%E8%BE%A6%E6%B3%95.pdf).
:::

```{=html}
<div class="journal-covers">
<a class="cover-item" href="https://www.journals.uchicago.edu/journals/jaere" target="_blank" rel="noopener" title="Journal of the Association of Environmental and Resource Economists"><img src="jaere-cover.jpg" alt="Journal of the Association of Environmental and Resource Economists cover" loading="lazy"><span class="cover-name">Journal of the Association of Environmental and Resource Economists</span></a>
...
::: paper-links
[Journal](https://archive.conscientiabeam.com/index.php/31/article/view/4940){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [ESCI]{.idx-badge}
:::
...
::: paper-links
[Journal](https://doi.org/10.1016/j.annale.2026.100209){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [ESCI]{.idx-badge}
:::

```{=html}
<div class="abstract-box"><ul><li>We explore the causal impact of a religious pilgrimage event on traffic accidents.</li><li>We use the Dajia Mazu Pilgrimage (DMP) event of Chinese society as an illustration.</li><li>We apply the difference-in-differences method and use administrative data of vehicle transportation and traffic accidents.</li><li>We find an increased number of non-fatal injury traffic accidents during the pilgrimage.</li><li>The loss of labor productivity and medical expenses contribute 6.3% to the total traffic accident costs in society.</li></ul></div>
...
::: paper-title
4\. Is Solar Panel Adoption a Win–Win Strategy for Chicken Farms? Evidence from Agriculture Census Data
:::
...
::: paper-links
[Journal](https://www.mdpi.com/2077-0472/15/20/2124){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SCIE]{.idx-badge}
:::
...
::: paper-title
3\. Rooftop Photovoltaics Adoption and Farm Revenue
:::

::: paper-meta
***Agribusiness***, advance online publication, 2025 (with Chang and Begun).
...
::: paper-links
[Journal](https://onlinelibrary.wiley.com/doi/abs/10.1002/agr.70035){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-title
2\. The impact of the carbon border adjustment mechanism policy on international trade and market competition — A theoretical justification
:::

::: paper-meta
***The Singapore Economic Review***, advance online publication, 2025 (with Chang and Begun).
:::

::: paper-links
[Journal](https://www.worldscientific.com/doi/10.1142/S0217590825500328){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-links
[Journal](https://link.springer.com/article/10.1007/s11135-024-01915-9){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle}
:::
...
```{=html}
<ol reversed start="11" class="wip-list">
<li>Does the Development of Aquavoltaics Production Affect Farmland Price? (with Chang).<span class="paper-earlier">Earlier version presented at the 17th CAER-IFPRI Annual Conference (2025).</span></li>
<li>The Effects of Enhancing Pedestrian-Protective Infrastructure on Intersection Safety (with Chang).</li>
<li>Do Consumption Vouchers Benefit Agricultural Cooperatives? Causal Evidence from Farmers' Associations (with Chang and Wu).<span class="paper-earlier">Earlier version presented at the 12th ASAE International Conference (2026).</span></li>
<li>Technology Adoption of Environmentally Controlled Housing System and the Distribution of Farm Revenue (with Chang).</li>
</ol>
```
...
```{=html}
<ol reversed start="7" class="wip-list">
<li>Green Gentrification beyond the City: The Impacts of Ecosystem Investment on Housing Markets and Agricultural Community Dynamics (with Chang).<span class="paper-earlier">Earlier version presented at the 21st EAEA International Convention (2026).</span></li>
<li>Does Adopting a Forest Restoration Program Affect Firms' Financial Performance? A Doubly Robust Machine Learning Approach (with Chang and Sun).</li>
<li>Cleaner Air and Smaller Transfers: Housing-Market Responses to a Coal-Reduction Policy (with Chang and Zilberman).<span class="paper-earlier">Earlier version presented at the 7th World Congress of Environmental and Resource Economists (2026).</span></li>
<li>The Spatial Reach of Metro-led Development: Housing Gains and Traffic-Safety Costs by Station Accessibility (with Chang).<span class="paper-earlier">Earlier version presented at the 21st EAEA International Convention (2026).</span></li>
</ol>
```
...
```{=html}
<ol reversed start="3" class="wip-list">
<li>Pension Policy Reform of the Minimum Contribution Period and Intra-household Succession of Family Farms (with Chang).<span class="paper-earlier">Earlier version presented at the AAEA Annual Meeting (2026).</span></li>
<li>From Gasoline to Electric: Economic and Environmental Impacts of Taxi Electrification (with Chang).</li>
<li>Trading Less Often but Trading Thicker: Scheduled Closures in a Hog Auction Market (with Lee and Chang).</li>
</ol>
```
...
<circle class="cmap-dot" cx="837.7" cy="166.6" r="5.6" data-place="Taipei · National Taiwan University" data-names="Chang, Hung-Hao&nbsp;· Liou, Ruey-Wan&nbsp;· Sun, Hsiao-Chiao&nbsp;· Wu, Karin&nbsp;· Yang, Feng-An"></circle>
<circle class="cmap-dot" cx="828" cy="168.1" r="4" data-place="Xiamen · Xiamen University of Technology" data-names="Lee, Tzong-Haw"></circle>
<circle class="cmap-dot" cx="160.3" cy="103.7" r="4" data-place="Seattle · University of Washington" data-names="Begun, Jeffrey C."></circle>
<circle class="cmap-dot" cx="189.4" cy="120.2" r="4" data-place="Logan · Utah State University" data-names="Kim, Man-Keun"></circle>
<circle class="cmap-dot" cx="160.4" cy="130.9" r="4" data-place="Berkeley · UC Berkeley" data-names="Zilberman, David"></circle>
<circle class="cmap-dot" cx="286" cy="114.5" r="4" data-place="Ithaca · Cornell University" data-names="Just, David R."></circle>
<circle class="cmap-dot" cx="296.5" cy="128.5" r="4" data-place="Princeton · Princeton University" data-names="Lee, Brian"></circle>
<circle class="cmap-dot" cx="288.5" cy="123" r="4" data-place="Bethlehem · Lehigh University" data-names="Meyerhoefer, Chad D."></circle>
</svg>
<div class="cmap-tip"></div>
</div>
<div class="cmap-scroll-hint" aria-hidden="true">← Swipe to explore →</div>
<script>
(function () {
...
- Sun, Hsiao-Chiao, National Taiwan University.
...
- [*Agribusiness*](https://onlinelibrary.wiley.com/journal/15206297) (5)
- [*Criminology & Public Policy*](https://onlinelibrary.wiley.com/journal/17459133) (1)
- [*Food Policy*](https://www.sciencedirect.com/journal/food-policy) (2)
...
- [*Managerial and Decision Economics*](https://onlinelibrary.wiley.com/journal/10991468) (1)
...
<li><strong>Liou, Y.-Y.</strong> 2021. "<a href="https://doi.org/10.6342/NTU202102085" target="_blank" rel="noopener">Using Multilevel Linear Modeling to Explore the Moderating Effect of External Attributes on Hotel Room Rates: Empirical Evidence on Public Goods and Industry Environment</a>." Master's Thesis, Master Program in Statistics, National Taiwan University.<br><em>Grade: A+. Committee: Yao-Wen Hsu, Yung-Chih Lien, and Shih-Ping Ho.</em></li>
<li><strong>劉昱佑</strong>（2021）。「<a href="https://doi.org/10.6342/NTU202101981" target="_blank" rel="noopener">農地價格指數之建構：應用臺灣實價登錄資料的大數據分析</a>」。國立臺灣大學農業經濟學系碩士論文。<br>[Constructing Property Price Indices: Big Data Analyses from Actual Price Registration of Real Estate Transactions in Taiwan. Master's Thesis, Department of Agricultural Economics, National Taiwan University.]<br><em>Grade: A+. Committee: Hung-Hao Chang, Yessica C. Y. Chung, Jiun-Hao Wang, Tzu-Chin Lin, and Sheng-Fu Tsai.</em></li>
</ol>
```
...
```{=html}
<ol class="conf-list" reversed>
<li><strong>劉昱佑</strong>、李成蔭（2024）。「從眾或課責？運用臺灣選舉調查資料探討 2018 年與 2022 年地方大選結果對於總統滿意度的影響」。第十六屆國會國際學術研討會，臺北。<br>[<strong>Liou, Y.-Y.</strong> and C.-Y. Lee. 2024. "Conformity or Accountability? An Analysis of Local Election Results on Presidential Satisfaction." 16th International Conference on Parliamentary Studies, Taipei.]</li>
...
<li><strong>劉昱佑</strong>（2023）。「選舉投票行為的時、空路徑依賴：2022 年臺北市長選舉的實證分析」。第十五屆國會國際學術研討會，臺北。<br>[<strong>Liou, Y.-Y.</strong> 2023. "Path Dependency of Spatiotemporal Voting Behavior: An Empirical Analysis of the 2022 Taipei Mayoral Election." 15th International Conference on Parliamentary Studies, Taipei.]</li>
<li>何驊哲、<strong>劉昱佑</strong>（2023）。「新人光環對於當選可能之影響：2009-2022 年臺灣縣市議員選舉的實證研究」。第十五屆國會國際學術研討會，臺北。<br>[Ho, H.-C. and <strong>Y.-Y. Liou</strong>. 2023. "The Impact of 'Newcomer Aura' on Election Probability: An Empirical Study of Taiwan's Councilor Elections (2009–2022)." 15th International Conference on Parliamentary Studies, Taipei.]</li>
<li><strong>劉昱佑</strong>、張宏浩（2020）。「以非階層式群集分析研究農產品之消費行為——農產品銷售平台的實證分析」。2020 年臺灣農村經濟學會年會暨學術研討會，臺北。<br>[<strong>Liou, Y.-Y.</strong> and H.-H. Chang. 2020. "A Non-hierarchical Clustering Analysis of Consumer Behavior in Agricultural Products." 2020 Annual Conference of the Taiwan Rural Economics Society, Taipei.]</li>
<li><strong>劉昱佑</strong>、陳林松（2019）。「生產力對於臺灣國內生產毛額的貢獻度（1981-2018）」。2019 年生產力與效率學術研討會，臺北。<br>[<strong>Liou, Y.-Y.</strong> and L. Chen. 2019. "The Contribution of Productivity to Taiwan's GDP Growth: An Empirical Analysis (1981–2018)." 2019 Taiwan Productivity and Efficiency Conference, Taipei.]</li>
</ol>
```
