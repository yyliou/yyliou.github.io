...
My research examines how public policy shapes environmental quality, public health, and safety. Using administrative and census data, I apply causal inference methods to quantify the environmental, health, and economic effects of government interventions.

My work spans two closely related areas of environmental and resource economics. The first studies the energy transition in agriculture and land use, including agrivoltaics, aquavoltaics, and farmland policy. The second examines environmental and health externalities in urban transportation, including carbon emissions, air pollution, housing markets, and traffic safety.

Across these areas, my research asks how policy should account for external costs and benefits that markets fail to price. By producing credible causal evidence on the impacts of environmental, energy, and transportation policies, I aim to improve policy design and help governments allocate scarce public resources more efficiently and equitably.
...
<div class="bib-stats">
  <div class="bib-stat">
    ...
    <div class="bib-number" data-target="15">0</div>
  </div>
  <div class="bib-stat">
...
::: paper-meta
***Journal of the Association of Environmental and Resource Economists***, 2026 (with Chang and Meyerhoefer, Conditionally Accepted). §

[Earlier version available on [SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4984614); presented at the 99th WEAI Annual Conference (2024) and the 11th IAAE Annual Conference.]{.paper-earlier}
:::

::: paper-links
[Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge}
:::

```{=html}
<div class="abstract-box"><p>Policymakers are under pressure to limit pollution emissions from large-scale religious observances, putting them in conflict with individuals seeking to practice religious rituals. Using the Hakka Tomb-Sweeping Day in Taiwan as an illustration, we show that better information on pollution sources and targeted measures of exposure yield more accurate estimates of the true pollution costs of religious practices. We find that religious activities lower overall air quality by 17.5% during the Tomb-Sweeping Day weekend and increase levels of specific pollutants by 13.6%–25.7%. In contrast to previous studies suggesting elevated pollution is due to the burning of incense, joss paper and fireworks, we identify greater motor vehicle use and lower travel speed as primary mechanisms. Policies designed to limit the surge in motor vehicle traffic during the holiday could reduce excess health-related costs by NT$33.1 million, equaling 34% of total inpatient and outpatient health care expenditures.</p></div>
<div class="bibtex-box"><pre><code>@article{chang2026airpollution,
...
::: paper-links
[Journal](https://doi.org/10.1016/j.tra.2026.104860){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [Media]{.paper-btn .media-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge}
:::
...
::: paper-links
[Journal](http://doi.org/10.1016/j.trd.2025.104903){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge}
:::
...
::: paper-note
*Note*: † Journals recommended by the NSTC, Division of Regional Studies and Geography; \* Journals recommended by the NSTC, Division of Economics. \^ Journals recommended by the NSTC, Division of Management II. ⁺ Journals ranked in the top 10% of their field based on the Journal Impact Factor. ‡ National Taiwan University distinguished journals (國立臺灣大學傑出期刊); § National Taiwan University outstanding journals (國立臺灣大學優良期刊).
:::

```{=html}
<div class="journal-covers">
<a class="cover-item" href="https://www.journals.uchicago.edu/journal/jaere" target="_blank" rel="noopener" title="Journal of the Association of Environmental and Resource Economists"><img src="https://www.journals.uchicago.edu/cms/asset/5a38d4f1-b01f-4f38-830f-3718a574ab3d/default_cover.gif" alt="Journal of the Association of Environmental and Resource Economists cover" loading="lazy"><span class="cover-name">JAERE</span></a>
...
::: paper-links
[Journal](https://onlinelibrary.wiley.com/doi/abs/10.1002/agr.70035){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge}
:::
...
::: paper-links
[Journal](https://www.worldscientific.com/doi/10.1142/S0217590825500328){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge}
:::
