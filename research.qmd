...
My research asks a simple but important question: how do governments' everyday decisions about energy and transportation affect people's environment, health, and safety? I was trained in agricultural economics and later in statistics and political science. This background has taught me to study public policy from both institutional and empirical perspectives. Instead of asking only what a policy is intended to achieve, I use administrative and census data to examine what it actually does.

Over time, my research has focused on environmental and resource economics in two related areas. The first is the energy transition in agriculture and land use, including agrivoltaics, aquavoltaics, and farmland use. The second is environmental and health externalities in urban transportation, such as the effects of public transportation on carbon emissions, air pollution, and housing prices, as well as the social costs of traffic accidents.

These topics are important because both the transition to a low-carbon economy and people's daily travel create high external costs that are often overlooked. These costs include carbon emissions, air pollution, traffic injuries and deaths, and the resulting healthcare costs and productivity losses. They are also unevenly distributed, with some communities and population groups bearing a much larger burden than others.

My goal is to provide credible causal evidence that helps improve public policy. For example, under what conditions can a public transit pass program reduce carbon emissions? How many injuries, deaths, and healthcare costs can be avoided by changing intersection rules or improving pedestrian infrastructure? Can agrivoltaic systems support both renewable energy production and agricultural income? By providing reliable estimates of policy benefits and costs, I hope my research can help governments make better use of limited public resources and design policies that are both effective and fair.
