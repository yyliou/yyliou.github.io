...
My research focuses on environmental economics and policy evaluation. I study how policy-induced changes in incentives affect behavior and, in turn, shape environmental quality and social welfare.

Many environmental outcomes, including air pollution, traffic accidents, and natural resource use, involve externalities that markets fail to price. I use causal inference methods and large-scale administrative data to evaluate whether policies achieve their intended goals and generate unintended consequences.

My research covers two themes. The first examines agricultural and environmental sustainability, focusing on how policies influence farmers’ technology adoption, production decisions, and resource use. The second studies urban environmental and transportation policies, evaluating interventions such as mass transit expansion, fare subsidies, and road safety programs.

Although these studies span rural and urban settings, they address a common question: how do policies reshape incentives and environmental outcomes. Through empirical analysis, I aim to provide evidence for more effective public policy design.
...
<script>
(function () {
  var VOS_BASE = 'https://app.vosviewer.com/?json=https%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D13Sdh41MoHPEq19gX7CxHdXWlg-OXSj6g&simple_ui=true';
...
[Earlier version presented at the 20th EAEA International Convention (2025), the 99th Annual Conference of WEAI (2024), and the 11th Annual Conference of the IAAE (2024).]{.paper-earlier}
:::

::: paper-links
[Journal](https://ssrn.com/abstract=4984614){.paper-btn} [Abstract]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [EconLit]{.idx-badge}
:::

```{=html}
<div class="abstract-box"><p>Religious holidays are associated with changes to usual routines and special religious practices that can worsen air pollution. Using the Hakka Tomb Sweeping Day in Taiwan as an illustration, we find that religious activities lower overall air quality by 10.8% and increase levels of specific pollutants by 9.8% - 18.6%. In contrast to previous studies suggesting elevated air pollution is due to the burning of incense, joss paper and fireworks, we identify greater motor vehicle use and a decrease in travel speed as primary mechanisms. Changes in traffic also lead to a 16% increase in injuries from motor vehicle accidents. In Hakka areas serviced by rail lines we find no increase in air pollution or injuries during Tomb Sweeping Day, highlighting the benefits of public transportation to accommodate holiday travel.</p></div>
...
<li>Cleaner Air, Smaller Transfers: Housing-Market Responses to a Coal-Reduction Policy (with Chang and Zilberman).<span class="paper-earlier">Earlier version presented at the 7th World Congress of Environmental and Resource Economists (2026).</span></li>
</ol>
```
