...
<figure class="figure">
<p><iframe id="vosviewerMap" class="vos-embed" allowfullscreen="true" width="100%" height="75%" style="max-width: 1000px; min-height: 500px" title="研究主題網絡圖，涵蓋經濟學、環境科學、農業、收益與COVID-19等主題" loading="lazy"></iframe></p>
...
::: paper-links
[期刊全文](http://doi.org/10.1016/j.trd.2025.104903){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
