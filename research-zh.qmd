...
空氣污染、交通事故與地下水超抽有一個共同點。造成損害的人不必承擔其成本。這正是環境與資源經濟學所稱的外部性，而政策則是主要的矯正工具。我的研究衡量政策實際矯正了多少，以及在此過程中產生哪些非預期效果。答案往往與政策原先的設想不同。我運用因果推論方法與大規模行政資料，研究場域涵蓋農業與都市兩大面向。
...
::: paper-note
*附註*：有三筆文獻無法對應至相應年份，因此未納入圖中。
:::

我的研究成果主要發表於區域研究與農業經濟學領域之國際期刊，包括知名的 *Journal of Transport Geography*、*Transportation Research Part A* 及 *Part D*、*Food Policy* 以及 *Forest Policy and Economics*。詳細研究成果請參閱[研究自述](https://yyliou.github.io/yyliou/rs/rs_zh.pdf)。

```{=html}
<div class="quarto-figure quarto-figure-center">
<figure class="figure">
<p><iframe id="vosviewerMap" class="vos-embed" allowfullscreen="true" width="100%" height="75%" style="max-width: 1000px; min-height: 500px" title="研究主題網絡圖，涵蓋經濟學、環境科學、農業、收益與 COVID-19 等主題" loading="lazy"></iframe></p>
<figcaption>研究主題網絡圖</figcaption>
</figure>
</div>
<script>
(function () {
...
::: paper-links
[期刊全文](https://doi.org/10.1086/743452){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-links
[期刊全文](https://doi.org/10.1016/j.foodpol.2026.103148){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-links
[期刊全文](https://doi.org/10.1016/j.tra.2026.104860){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [媒體報導]{.paper-btn .media-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-links
[期刊全文](https://doi.org/10.1016/j.trd.2025.104903){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-links
[期刊全文](https://doi.org/10.1016/j.forpol.2024.103411){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge}
:::
...
::: paper-links
[期刊全文](https://doi.org/10.1016/j.jtrangeo.2021.102954){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge}
:::
...
::: paper-note
*附註*：† 國科會區域研究及地理學門推薦國際期刊；\* 國科會經濟學門 B+ 國際期刊；\^ 國科會管理二學門推薦國際期刊；⁺ 期刊影響因子位於該領域前 10%；‡ 國立臺灣大學傑出期刊；§ 國立臺灣大學優良期刊；¶ 國立臺灣大學高被引著作（FWCI 前 5%）。國科會推薦期刊之認定參照[國科會人文及社會科學研究發展處各學門審查參考原則](https://www.nstc.gov.tw/hum/ch/detail/da71f59b-9ab8-41f4-ae93-5973e0701cc7)；臺大傑出期刊、優良期刊與高被引著作之定義參照[國立臺灣大學學術研究績效獎勵辦法](https://ord.ntu.edu.tw/WebUPD/ordntu/GW/1140521%E5%9C%8B%E7%AB%8B%E8%87%BA%E7%81%A3%E5%A4%A7%E5%AD%B8%E5%AD%B8%E8%A1%93%E7%A0%94%E7%A9%B6%E7%B8%BE%E6%95%88%E7%8D%8E%E5%8B%B5%E8%BE%A6%E6%B3%95.pdf)。
:::
...
::: paper-links
[期刊全文](https://onlinelibrary.wiley.com/doi/abs/10.1002/agr.70035){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge} [EconLit]{.idx-badge}
:::
...
::: paper-links
[期刊全文](https://www.worldscientific.com/doi/10.1142/S0217590825500328){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [EconLit]{.idx-badge}
:::
