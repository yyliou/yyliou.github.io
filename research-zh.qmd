...
::: paper-links
[期刊全文](https://doi.org/10.1016/j.tra.2026.104860){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [SSCI]{.idx-badge} [SCIE]{.idx-badge}
:::
...
::: paper-links
[期刊全文](https://archive.conscientiabeam.com/index.php/31/article/view/4940/9198){.paper-btn} [摘要]{.paper-btn .abs-toggle} [BibTeX]{.paper-btn .bib-toggle} [ESCI]{.idx-badge}
:::
...
<circle class="cmap-dot" cx="837.7" cy="166.6" r="5.6" data-place="臺北 · 國立臺灣大學" data-names="張宏浩、劉瑞文、巫凱琳、楊豐安"></circle>
